        ...
        {administration && <>
          ...
          <div className="mt-8 ml-4 mr-4">
            <Accordion activeIndex={accordionStatus} onTabChange={(e) => setAccordionStatus(e.index)}>
              ...
              {administration.checkInStartTime && administration.checkInEndTime && administration.checkOutEndTime && <AccordionTab header={_t.page_pdp.check_in_out_info || 'Check-in & Check-out info'}>
                <div className="grid">
                  <div className="col-1">
