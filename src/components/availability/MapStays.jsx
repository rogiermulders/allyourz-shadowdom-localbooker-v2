...
const mapboxConfig = {
  'ScrollZoomBlocker.CtrlMessage': {
    ...
    nl: 'Gebruik ⌘ + scrollen om in te zoomen op de kaart', de: 'Verwenden Sie ⌘ + Scrollen, um die Karte zu vergrößern'
  }, 'TouchPanBlocker.Message': {
    nl: 'Gebruik twee vingers om de kaart te verplaatsen', de: 'Verschieben Sie die Karte mit zwei Fingern'
  }
}
...
function MapStays({width, height, request}) {
  ...
  useEffect(() => {
    ...
    const marker = process.env.REACT_APP_WHITELABEL + '/mapbox/STAYS/marker-'
